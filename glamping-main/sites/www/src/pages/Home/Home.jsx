    ...
    <Box>
      ...
      >
        ...
        <Button
          ...
          sx={{
            ...
            borderColor: 'white',
            borderWidth: '3px',
            padding: { xs: '1rem 4rem', md: 'clamp(1rem, 2vw, 1.2rem) clamp(3rem, 6vw, 5rem)' },
      ...
      <Box
        sx={{
          ...
          padding: { xs: '3rem 2rem', md: 'clamp(3rem, 5vw, 5rem) clamp(2rem, 4vw, 4rem)' },
          display: 'flex',
          flexDirection: { xs: 'column', md: 'row' },
          flexWrap: 'wrap',
          borderRadius: { xs: '50px 0 50px 0', md: 'clamp(50px, 8vw, 80px) 0 clamp(50px, 8vw, 80px) 0' },
          alignItems: 'center',
          textAlign: 'center',
          ...
          margin: { xs: '-50px auto 0', md: 'clamp(-60px, -8vw, -80px) auto 0' },
        }}
      >
        <Typography
          variant="h2"
            ...
            >
              <Card
                sx={{
                  ...
                  color: 'white',
                  padding: '2rem',
                  borderRadius: { xs: '30px 0 30px 0', md: 'clamp(30px, 4vw, 40px) 0 clamp(30px, 4vw, 40px) 0' },
                  textAlign: 'center',
                  minHeight: { xs: '150px', md: 'clamp(150px, 18vw, 180px)' },
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                }}
              ...
              >
                <Card
                  sx={{
                    ...
                    borderRadius: { xs: '30px 0 30px 0', md: 'clamp(30px, 4vw, 40px) 0 clamp(30px, 4vw, 40px) 0' },
                    textAlign: 'center',
                    minHeight: { xs: '200px', md: 'clamp(200px, 25vw, 250px)' },
                    display: 'flex',
                    flexDirection: 'column',
                    justifyContent: 'center',
                  }}
                >
                  <CardContent sx={{ padding: 0, '&:last-child': { paddingBottom: 0 } }}>
                    <Typography
                      variant="h2"
                      sx={{
                        fontSize: { xs: '2rem', md: 'clamp(2rem, 2.5vw, 2.2rem)' },
                        fontWeight: 300,
                        margin: '0 0 0.2rem 0',
                      }}
                    >
                    ...
                    <Typography
                      sx={{
                        fontSize: { xs: '0.95rem', md: 'clamp(0.95rem, 1.3vw, 1.1rem)' },
                        lineHeight: 1.6,
                        margin: 0,
                        fontWeight: 300,
                      }}
